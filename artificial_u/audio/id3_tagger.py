    ...
    def generate_comment(
        ...
        Args:
            ...
            include_elevenlabs: Whether to mention ElevenLabs voice synthesis
                (legacy, ignored if tts_backend is provided)
            tts_backend: TTS backend name (e.g., "elevenlabs", "mistral")
        ...
        # Determine TTS provider display name
        tts_display = None
        if tts_backend:
            provider_names = {
            ...
            tts_display = provider_names.get(tts_backend, tts_backend)
        elif include_elevenlabs:
            tts_display = "ElevenLabs"

        if tts_display:
            synthesis_text = f"{tts_display} voice synthesis"
            if parts:
