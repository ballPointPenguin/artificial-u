#!/usr/bin/env python3
"""
Script to run Alembic commands within the Hatch environment.
...
def main():
    ...
    try:
        ...
        print("Error: alembic command not found. Make sure you're in the Hatch environment.")
        print("Run: hatch shell")
        sys.exit(1)
