...
def test_api_connection(audio_processor):
    ...
    if subscription:
        ...
        console.print(f"Available characters: {subscription.get('available_characters', 'Unknown')}")
...
def test_text_to_speech(audio_processor, test_professor, test_lecture):
    ...
    # Generate speech
    audio_path, audio_data = audio_processor.text_to_speech(test_lecture, test_professor)
