...
export const en = {
  ...
  professorDetail: {
    ...
    backToProfessor: '← Back to Professor',
    coursesTaught: 'Courses Taught',
    loadingCourses: 'Loading courses...',
    errorLoadingCourses: 'Error loading courses:',
    noCoursesTaught: 'This professor is not currently teaching any courses.',
    voiceProfile: 'Voice Profile',
    voiceSelectionAndPreview: 'Voice Selection & Preview',
    loadingVoice: 'Loading voice details...',
    errorLoadingVoice: 'Error loading voice details:',
    loadingProfessor: 'Loading professor details...',
    errorLoadingProfessor: 'Error loading professor:',
    editHeading: 'Edit Professor',
    failedToUpdate: 'Failed to update professor',
    failedToDelete: 'Failed to delete professor',
    ...
    invalidId: 'Professor ID is missing or invalid',
    imageGeneratedWith: 'Image generated with {engine}',
    confirmDeleteTitle: 'Delete Professor',
    confirmDeleteMessage: 'Are you sure you want to delete this professor?',
    confirmDeleteUndo: 'This action cannot be undone.',
  },

  // Professor Voice page/component
  professorVoice: {
    voiceSelectionTitle: 'Voice Selection — {name}',
    currentVoice: 'Current Voice',
    showAllEmotions: 'Show all emotional tones (including sad/angry/frustrated/etc.)',
    browseMistral: 'Browse Voxtral voices and preview them before assigning.',
    ...
    assignButton: 'Assign',
    assignSpecificVoice: 'Assign "{name}"',
    assigning: 'Assigning...',
    tryAnotherVoice: 'Try another voice',
    autoPickDescription:
      "Automatically pick a matching ElevenLabs voice based on this professor's attributes (gender, accent, age).",
    reassignVoice: 'Reassign Voice',
    reassigning: 'Reassigning...',
    generateNewVoice: 'Generate a New Voice',
    experimental: 'Experimental',
    customVoiceDescription:
      "Create a custom ElevenLabs voice from this professor's attributes. Listen to the options and choose your favourite.",
    generateOptions: 'Generate Options',
    generating: 'Generating...',
    useThisVoice: 'Use This Voice',
    saving: 'Saving...',
    cloneToMistral: 'Clone to Mistral',
    cloneDescription:
      'Clone this voice into your Mistral library and switch the professor to Voxtral TTS.',
    cloning: 'Cloning...',
    successAssigned: 'Voice assigned successfully ({backend}: {id}).',
    successReassigned: 'Voice reassigned successfully.',
    successCloned: 'Voice cloned to Mistral successfully.',
    successSavedDesigned: 'New voice saved and assigned successfully.',
    errorEnterId: 'Please enter an ElevenLabs voice ID.',
    errorSelectVoice: 'Please select a voice first.',
    errorNoIdentifier: 'No voice identifier found.',
    errorAssignFailed: 'Assignment failed.',
    errorReassignFailed: 'Reassignment failed.',
  ...
  departmentDetail: {
    ...
    loadingDepartment: 'Loading department information...',
    description: 'Description',
